...
def defineLocalProc(node, uversion = ''):
    ...
    elif 'DEP' in node.upper() or 'GELDER' in node.upper():
        localProc = 'E:\\DEP_Proc'
    else:
        localProc = 'C:\\DEP_Proc'
...
def figureItOut(inputRasterOrFeature):
    ...
    if ('ef' in basename or 'et' in basename or 'ep' in basename or 'ec' in basename or 'ev' in basename or 'ex' in basename or 'ey' in basename) and len(fillbaseNoExt) >= 14:
